...
- Name: security_governance.spec.ts >> Security Governance >> should trigger MFA setup flow and display QR section
- Location: tests\security_governance.spec.ts:63:7
...
waiting for navigation until "domcontentloaded"
  navigated to "http://localhost:3400/es/login"
============================================================
```
