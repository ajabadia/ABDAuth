...
- Name: security_governance.spec.ts >> Security Governance >> should display active sessions in the governance portal
- Location: tests\security_governance.spec.ts:23:7
