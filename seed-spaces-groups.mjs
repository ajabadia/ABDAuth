// ---------------------------------------------------------------------------
// seed-spaces-groups.mjs
// Seeds test Spaces and PermissionGroups for tenant 'banco-parque'
//
// The ecosystem uses COLLECTION_PREFIX isolation strategy:
//   dbPrefix = 'bancoparque'
//   collections: bancoparque_spaces, bancoparque_permissiongroups
//
// Run: node seed-spaces-groups.mjs
// ---------------------------------------------------------------------------
