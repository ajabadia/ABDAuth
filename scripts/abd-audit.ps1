...
Run-AuditStep -Name "5/6 Type Safety (TSC)" -ExecCmd "node"  -StepArgs @("node_modules/typescript/bin/tsc", "--noEmit")
Run-AuditStep -Name "6/6 Code Quality    " -ExecCmd "node"  -StepArgs @("node_modules/eslint/bin/eslint.js", "src", "--quiet")
